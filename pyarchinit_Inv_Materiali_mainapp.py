...
class pyarchinit_Inventario_reperti(QDialog, Ui_DialogInventarioMateriali):
    ...
    def fill_fields(self, n=0):
        ...
        try:
            ...
            unicode(
                self.comboBox_tipo_reperto.setEditText(self.DATA_LIST[self.rec_num].tipo_reperto))  # 3 - Tipo reperto
            unicode(self.comboBox_criterio_schedatura.setEditText(
            ...
            unicode(
                self.textEdit_descrizione_reperto.setText(self.DATA_LIST[self.rec_num].descrizione))  # 6 - descrizione
            ...
            unicode(self.lineEdit_luogo_conservazione.setText(
            ...
            unicode(self.lineEdit_datazione_rep.setText(
